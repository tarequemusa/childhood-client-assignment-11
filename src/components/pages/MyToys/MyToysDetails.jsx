...
const MyToysDetails = () => {
    ...
    return (
        <div className="container px-12 mx-auto mb-14">
            <h2 className='text-xl font-bold border-b-4 text-center my-12'><span className='rounded-full outline px-2 bg-pink-700 text-white'>Toy Details Information</span></h2>
            <div className=" flex justify-center mb-6"><img className="rounded-xl outline w-3/12 border-spacing-4" src={image} alt="" /></div>
